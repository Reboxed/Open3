...
import redis, { USER_CHATS_INDEX_KEY } from "@/internal-lib/redis";
...
export async function POST(req: Request) {
    ...
    // turn the request body into an array of ids
    let ids: string[] = [];
    try {
    ...
    // check in redis if these ids exist in the chats index
